...
const projects = [
  {
    ...
    desc: "Réhabilitation et revêtement bitumineux de la RN8. Finisseurs et compacteurs à pneus pour la pose d'enrobé sur plusieurs dizaines de kilomètres.",
  ...
  },
  {
    ...
    desc: "Revêtement routier avec nos finisseurs et compacteurs. Mise en œuvre d'enrobé bitumineux sur toute la longueur du projet.",
    client: 'LEBDA',
    resp: 'THOMAS YAMEOGO',
  },
]
